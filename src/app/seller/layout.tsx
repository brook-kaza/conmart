    ...
    <div className="flex min-h-screen flex-col md:flex-row">
        ...
        <div className="flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <span className="ml-1 text-[10px] font-medium text-muted-foreground uppercase">Seller</span>
            </div>
          </div>
      ...
      <header className="flex h-14 items-center justify-between border-b border-border bg-card px-4 md:hidden">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-bold tracking-tight">ConMart</span>
          <span className="text-[10px] font-medium text-muted-foreground uppercase">Seller</span>
        </div>
        <div className="flex items-center gap-2">
          <LanguageToggle />
          <ThemeToggle />
